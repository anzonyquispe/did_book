...
```
Note: The R DIDmultiplegtSTAT and Python py_did_multiplegt_stat packages
are not yet updated to match the current Stata version. Results will be
added when the packages are synchronized.
```
