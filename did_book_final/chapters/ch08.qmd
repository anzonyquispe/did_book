...
![R PanelView](../figures/ch05_panelview_R.png)
...
ax.set_yticks([])
ax.set_xlabel("Year")
ax.set_title("Treatment Status: Gentzkow et al. (2011)", fontsize=16)
...
![Python PanelView](../figures/ch05_panelview_Python.png)
