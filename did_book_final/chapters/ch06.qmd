...
**Interpretation:** Pre-treatment placebos (pre1–pre13) are all small and insignificant, supporting parallel trends. Post-treatment effects follow the same pattern as the other estimators: positive effects for 0–7 years, turning negative from year 8 onward. The `did_imputation` package is available in Stata and R only.
...
import pandas as pd
df = pd.read_parquet("https://raw.githubusercontent.com/anzonyquispe/did_book/main/cc_xd_didtextbook_2025_9_30/Data%20sets/Wolfers%202006/wolfers2006_didtextbook.parquet")
# Three-panel plot (BJS/did_imputation not available in Python)
fig, axes = plt.subplots(1, 3, figsize=(18, 5))
es_plot(axes[0], rt_fig62, co_fig62, lo_fig62, hi_fig62, "TWFE estimates", xlim=(-9.5, 16.5))
es_plot(axes[1], sa_rt, sa_co, sa_lo, sa_hi, "Sun & Abraham")
es_plot(axes[2], cs_rt, cs_co, cs_lo, cs_hi, "Callaway & Sant'Anna")
plt.suptitle("Effects of Unilateral Divorce Laws", fontsize=14)
fig.text(0.5, 0.01,
    "95% CIs shown in red. Weighted by state population. SEs clustered at state level.\nNote: BJS panel omitted (did_imputation not available in Python).",
    ha='center', fontsize=9, style='italic')
plt.tight_layout(rect=[0, 0.05, 1, 0.95])
plt.savefig(FIGDIR / "ch06_fig63_3panel_Python.png", dpi=150)
```
