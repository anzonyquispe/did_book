...
use "moser_voena_didtextbook.dta", clear
reg patents i.year treatmentgroup reltimeminus* reltimeplus*, cluster(subclass)
coefplot, keep(reltimeminus* reltimeplus*) vertical ///
    yline(0) xline(18.5, lpattern(dash)) ///
    xtitle("Relative time to year before TWEA") ///
    ytitle("Effect") title("TWFE Event-study estimates") ///
    ciopts(recast(rcap) color(cranberry))
