...
```
Example 1 (feols with i(year)):
     Estimate Std. Error  t value   Pr(>|t|)
twea 0.288262   0.038887  7.412783 1.3770e-13 ***

Example 2 (feols with subclass + year):
     Estimate Std. Error t value  Pr(>|t|)
...
Estimation:  OLS
Dep. var.: patents, Fixed effects: subclass
Inference:  CRV1
Observations:  289920
...
| C(year)[T.1901] |      0.006 |        0.008 |     0.765 |      0.444 | -0.009 |   0.021 |
| C(year)[T.1902] |      0.006 |        0.008 |     0.708 |      0.479 | -0.010 |   0.022 |
| C(year)[T.1903] |      0.035 |        0.009 |     3.966 |      0.000 |  0.018 |   0.052 |
| C(year)[T.1904] |      0.018 |        0.009 |     2.138 |      0.033 |  0.002 |   0.035 |
| C(year)[T.1905] |      0.021 |        0.009 |     2.329 |      0.020 |  0.003 |   0.039 |
| C(year)[T.1906] |      0.043 |        0.009 |     4.654 |      0.000 |  0.025 |   0.061 |
| C(year)[T.1907] |      0.102 |        0.010 |     9.758 |      0.000 |  0.081 |   0.122 |
| C(year)[T.1908] |      0.058 |        0.010 |     5.855 |      0.000 |  0.039 |   0.078 |
| C(year)[T.1909] |      0.087 |        0.011 |     7.984 |      0.000 |  0.065 |   0.108 |
| C(year)[T.1910] |      0.058 |        0.010 |     5.961 |      0.000 |  0.039 |   0.078 |
| C(year)[T.1911] |      0.087 |        0.011 |     7.889 |      0.000 |  0.065 |   0.108 |
| C(year)[T.1912] |      0.109 |        0.011 |    10.027 |      0.000 |  0.088 |   0.131 |
| C(year)[T.1913] |      0.069 |        0.011 |     6.080 |      0.000 |  0.046 |   0.091 |
| C(year)[T.1914] |      0.153 |        0.013 |    11.953 |      0.000 |  0.128 |   0.178 |
| C(year)[T.1915] |      0.204 |        0.016 |    12.901 |      0.000 |  0.173 |   0.235 |
| C(year)[T.1916] |      0.247 |        0.018 |    13.936 |      0.000 |  0.212 |   0.282 |
| C(year)[T.1917] |      0.234 |        0.016 |    14.694 |      0.000 |  0.203 |   0.266 |
| C(year)[T.1918] |      0.203 |        0.016 |    12.818 |      0.000 |  0.172 |   0.234 |
| C(year)[T.1919] |      0.170 |        0.013 |    12.578 |      0.000 |  0.143 |   0.196 |
| C(year)[T.1920] |      0.163 |        0.014 |    11.455 |      0.000 |  0.135 |   0.191 |
| C(year)[T.1921] |      0.210 |        0.015 |    14.170 |      0.000 |  0.181 |   0.239 |
| C(year)[T.1922] |      0.224 |        0.015 |    15.227 |      0.000 |  0.195 |   0.252 |
| C(year)[T.1923] |      0.184 |        0.015 |    12.575 |      0.000 |  0.155 |   0.212 |
| C(year)[T.1924] |      0.231 |        0.016 |    14.600 |      0.000 |  0.200 |   0.262 |
| C(year)[T.1925] |      0.245 |        0.016 |    15.479 |      0.000 |  0.214 |   0.276 |
| C(year)[T.1926] |      0.280 |        0.016 |    18.065 |      0.000 |  0.250 |   0.310 |
| C(year)[T.1927] |      0.212 |        0.014 |    15.354 |      0.000 |  0.185 |   0.239 |
| C(year)[T.1928] |      0.231 |        0.014 |    16.364 |      0.000 |  0.204 |   0.259 |
| C(year)[T.1929] |      0.298 |        0.016 |    18.926 |      0.000 |  0.267 |   0.329 |
| C(year)[T.1930] |      0.313 |        0.016 |    19.844 |      0.000 |  0.282 |   0.344 |
| C(year)[T.1931] |      0.511 |        0.020 |    25.109 |      0.000 |  0.472 |   0.551 |
| C(year)[T.1932] |      0.577 |        0.021 |    27.115 |      0.000 |  0.535 |   0.618 |
| C(year)[T.1933] |      0.574 |        0.020 |    29.292 |      0.000 |  0.536 |   0.613 |
| C(year)[T.1934] |      0.586 |        0.020 |    29.800 |      0.000 |  0.547 |   0.624 |
| C(year)[T.1935] |      0.556 |        0.019 |    29.074 |      0.000 |  0.518 |   0.593 |
| C(year)[T.1936] |      0.636 |        0.020 |    31.406 |      0.000 |  0.596 |   0.676 |
| C(year)[T.1937] |      0.595 |        0.019 |    32.081 |      0.000 |  0.558 |   0.631 |
| C(year)[T.1938] |      0.644 |        0.019 |    33.170 |      0.000 |  0.606 |   0.682 |
| C(year)[T.1939] |      0.777 |        0.023 |    34.512 |      0.000 |  0.733 |   0.821 |
---
RMSE: 0.978 R2: 0.479 R2 Within: 0.048 
...
```stata
gen reltimeminus0 = year == 1918
local order_evtime ""
forvalues i = 18(-1)0 {
    local order_evtime "`order_evtime' reltimeminus`i'"
}
forvalues i = 1/21 {
    local order_evtime "`order_evtime' reltimeplus`i'"
}

dis("`order_evtime'")
reg patents i.year treatmentgroup `order_evtime', cluster(subclass)


coefplot, keep(`order_evtime') order(`order_evtime') omitted vertical ///
    rename(reltimeminus(\d+) = "-\1" reltimeplus(\d+) = "\1", regex) ///
    recast(connected) ///
    lcolor(black) mcolor(black) mfcolor(white) ///
    yline(0) xline(19) ///
    yscale(range(-0.25 1)) ylabel(-0.25(0.25)1) ///
    xtitle("Relative time to year before TWEA") ///
    ytitle("Effect") ///
    xlabel(1 "-18" 3 "-16" 5 "-14" 7 "-12" 9 "-10" 11 "-8" ///
           13 "-6" 15 "-4" 17 "-2" 19 "0" ///
           21 "2" 23 "4" 25 "6" 27 "8" 29 "10" ///
           31 "12" 33 "14" 35 "16" 37 "18" 39 "20", nogrid) ///
    xline(3 7 11 15 23 27 31 35 39, lcolor(gs12) lpattern(dot) lwidth(thin)) ///
    title("TWFE Event-study estimates") ///
    ciopts(recast(rcap) color(black) lpattern(solid))
...
```r
library(fixest); library(haven);library(ggfixest);
options(digits=7)
setwd("/Users/anzony.quisperojas/Documents/GitHub/did_book/did_book_final")
load(url("https://raw.githubusercontent.com/anzonyquispe/did_book/main/cc_xd_didtextbook_2025_9_30/Data%20sets/Moser%20and%20Voena%202012/moser_voena_didtextbook.RData"))
df$evtime = df$year -1918
names(df)
model4 <- feols(patents~ i(evtime, treatmentgroup, ref = 0) + treatmentgroup | year, data = df, cluster = ~subclass)
p <- ggiplot(model4, geom_style = "errorbar") +
  geom_line(aes(group = 1), color = "black") +
  theme_minimal()

# Save as PDF
ggsave(
  filename = "figures/ch03_fig32_es_twfe_R.png",
  plot = p,
  width = 8,
  height = 5,
  units = "in"
