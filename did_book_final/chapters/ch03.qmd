...
> > Using the `moser_voena_didtextbook` dataset, estimate the ES-TWFER in (3.29) with patents as the outcome. Are the estimated effects of compulsory licensing in this regression similar to those we obtained estimating (3.7)? Are the effects more precisely estimated?.
